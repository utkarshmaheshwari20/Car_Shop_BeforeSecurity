...
<body>
	...
	<div class="container-wrapper">
		<div class="container-fluid">
			<form:form method="POST"
				action="${pageContext.request.contextPath}/supplier/addSupplier" modelAttribute="command">
	...
	<center><a type="button" class="btn btn-warning btn-lg" href="${pageContext.request.contextPath}/supplier/listallsupplier">Click here to see all suppliers </a></center>
	</div>
	<br>
	<br>
