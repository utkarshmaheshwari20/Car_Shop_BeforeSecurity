	...
	<div id="myCarousel" class="carousel slide margin-t70"
		...
		<div class="carousel-inner">
			<div class="item active">
				<img src="resources/images/veyron1.jpg" class="img-responsive">
				<div class="container">
			...
			<div class="item">
				<img
					src="https://images.cardekho.com/images/featuredcarimages/-36/m3w21-0.jpg"
			...
			<div class="item">
				<img
					src="https://images.cardekho.com/images/uploadimages/1509507889716/ccp.jpg"
					class="img-responsive">
				<div class="container">
					<div class="caraous-title">
						<div class="col-md-12">
