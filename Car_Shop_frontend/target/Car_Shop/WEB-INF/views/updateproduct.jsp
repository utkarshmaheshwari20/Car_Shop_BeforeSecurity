...
<body>
	...
	<div class="container-wrapper">
		...
		<form class="form-horizontal"
			action="${pageContext.request.contextPath}/products/updateProduct"
			method="post">
			<fieldset>
				<div class="container-fluid">
					...
					<div class="form-group">
						<label class="col-md-4 control-label" for="image">Img Name</label>
						<div class="col-md-4">
							<input id="imgName" name="imgName" placeholder=""
								value="${p.imgName }" class=" form-control
								input-md"
								required="" type="text">
						</div>
					</div>
